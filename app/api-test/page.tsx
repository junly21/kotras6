...
export default function SessionApiTest() {
  ...
  return (
    <ProtectedRoute requiredPath="/api-test">
      <div className="p-8">
        ...
        <div className="mb-6 p-4 border rounded bg-gray-50">
          ...
          <p className="text-sm text-gray-600 mt-2">
            세션은 HttpOnly 쿠키로 관리되며, 브라우저에서 직접 접근할 수
            없습니다.
          </p>
        </div>
        ...
        <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
          ...
          <div className="text-sm text-blue-700 space-y-2">
            <p>
              <strong>1. 세션 생성:</strong> 외부 서버 → JSESSIONID → 우리
              ext_sid 쿠키
            </p>
            <p>
              <strong>2. 세션 조회:</strong> 우리 ext_sid 쿠키 → JSESSIONID →
              외부 서버
            </p>
            <p>
              <strong>3. 보안:</strong> HttpOnly 쿠키로 XSS 공격 방지, 도메인
              격리
            </p>
            <p>
