...
import { useRouteDestinationOptions } from "@/hooks/useRouteDestinationOptions";
...
export default function PathKeyPage() {
  ...
  const handleFilterChange = useCallback(
    (values: RouteSearchFilter) => {
      ...
      if (values.RIDE_STN_ID && values.RIDE_STN_ID !== filters.RIDE_STN_ID) {
        ...
        // 도착역 옵션 API 호출
        fetchDestinationOptions(values.PATH_GRP_ID, values.RIDE_STN_ID);
  ...
  }, [destinationOptions, filters.PATH_GRP_ID, filters.RIDE_STN_ID]);
