...
export const nodeColDefs: ColDef<NodeData>[] = [
  ...
  { headerName: "노선", field: "subway", width: 100, resizable: true },
  { headerName: "운영기관", field: "oper", width: 150, resizable: true },
...
export const linkColDefsForCsv: ColDef<LinkData>[] = [
  { headerName: "순번", field: "seq", width: 80, resizable: true },
  { headerName: "출발역", field: "from_sta_nm", width: 150, resizable: true },
  {
    headerName: "출발역번호",
    field: "from_sta_num",
  ...
  { headerName: "비용", field: "cost", width: 100, resizable: true },
  { headerName: "거리(km)", field: "km", width: 100, resizable: true },
  { headerName: "노선", field: "subway", width: 100, resizable: true },
  {
    headerName: "개통일",
    field: "open_date",
  ...
  { headerName: "시작X좌표", field: "start_x", width: 120, resizable: true },
  { headerName: "시작Y좌표", field: "start_y", width: 120, resizable: true },
  { headerName: "종료X좌표", field: "end_x", width: 120, resizable: true },
  { headerName: "종료Y좌표", field: "end_y", width: 120, resizable: true },
  { headerName: "거리_지하", field: "km_g", width: 100, resizable: true },
  { headerName: "거리_지상", field: "km_ung", width: 100, resizable: true },
  {
    headerName: "시작운영사",
    field: "start_oper",
    width: 150,
  ...
  { headerName: "종료운영사", field: "end_oper", width: 150, resizable: true },
  { headerName: "방향", field: "direction", width: 100, resizable: true },
  { headerName: "운영기관", field: "oper", width: 150, resizable: true },
  { headerName: "운영노선", field: "oper_line", width: 150, resizable: true },
  {
    headerName: "위탁운영사",
    field: "consign_oper",
    width: 150,
  ...
  { headerName: "총고도", field: "elev_tot", width: 100, resizable: true },
  { headerName: "지상고도", field: "elev_ung", width: 100, resizable: true },
  { headerName: "고도", field: "elev", width: 100, resizable: true },
  { headerName: "지하고도", field: "elev_g", width: 100, resizable: true },
];

// CSV 내보내기용 전체 컬럼 정의 (모든 필드 포함)
export const platformColDefsForCsv: ColDef<PlatformData>[] = [
  { headerName: "순번", field: "seq", width: 80, resizable: true },
  { headerName: "링크순번", field: "link_seq", width: 100, resizable: true },
  { headerName: "링크코드", field: "link_cd", width: 120, resizable: true },
  { headerName: "출발역", field: "from_sta_nm", width: 150, resizable: true },
  { headerName: "출발방향", field: "from_dic", width: 150, resizable: true },
  {
